...
function HelloBar() {
    return (
        <a
            ...
            target="_blank"
            className="hidden md:flex w-full items-center justify-center  bg-blue-600/10 py-3 hover:bg-blue-600/30  transition-colors"
        >
            <div className="flex items-center justify-center gap-4 px-4">
                ...
                <div className="h-4 w-px bg-blue-500/40"></div>
